...
import { ArrowRight, Calendar, Wallet, Edit, UserCheck } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">Rs. {totalReceived.toFixed(2)}</div>
            ...
            <Card key={donation.id} className="flex flex-col">
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    <CardTitle className="text-lg">Rs. {donation.amount.toFixed(2)}</CardTitle>
